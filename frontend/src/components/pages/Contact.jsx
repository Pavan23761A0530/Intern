...
const Contact = () => {
  ...
  const faqs = [
    { q: "How can I apply for admission?", a: "You can apply by visiting our campus or by clicking the 'Apply for Admission' button on our website. Our admission office will guide you through the documentation and interview process." },
    { q: "Is hostel facility available?", a: "Yes, we provide separate hostel facilities for boys and girls with modern amenities, nutritious food, and 24/7 security." },
    { q: "Are transport services available?", a: "Yes, our GPS-enabled bus fleet covers a wide area including Tadikalapudi and surrounding villages in Eluru district." },
    { q: "How can I schedule a campus visit?", a: "You can call our office or fill out the contact form to schedule a visit. We recommend visiting during office hours (8:30 AM – 4:00 PM) for a full tour." },
    { q: "What curriculum does the school follow?", a: "KRR BrightMinds School follows the CBSE curriculum with an emphasis on NEP 2020-aligned learning methods." }
  ]
    ...
    <div className="min-h-screen bg-white font-body text-navy-800">
      ...
      <section className="relative h-[400px] lg:h-[450px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 animate-fade-in-up">
            Contact <span className="text-gold-400">KRR BrightMinds</span> School
          </h1>
          <p className="max-w-3xl mx-auto text-navy-100 text-lg md:text-xl leading-relaxed animate-fade-in-up animation-delay-200">
            We are here to help parents and students with admissions, academics, hostel facilities, transport, and general inquiries.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-navy-50 p-8 rounded-[2rem] border border-navy-100 shadow-sm hover:shadow-md transition-all group">
              ...
              <h3 className="text-xl font-heading font-bold text-navy-900 mb-4">Our Location</h3>
              <p className="text-navy-600 leading-relaxed">
                Tadikalapudi Village, Kamavarapukota Mandalam, Eluru District, Andhra Pradesh - 534452
              </p>
            </div>
            ...
            <div className="bg-navy-50 p-8 rounded-[2rem] border border-navy-100 shadow-sm hover:shadow-md transition-all group">
              ...
              <h3 className="text-xl font-heading font-bold text-navy-900 mb-4">Call Us</h3>
              <div className="space-y-2">
                <a href="tel:08823258055" className="block text-navy-600 hover:text-gold-600 transition-colors">08823-258055</a>
                <a href="tel:+919652993865" className="block text-navy-600 hover:text-gold-600 transition-colors">+91 96529 93865</a>
                <a href="tel:+919346633116" className="block text-navy-600 hover:text-gold-600 transition-colors">+91 93466 33116</a>
              </div>
            </div>
            ...
            <div className="bg-navy-50 p-8 rounded-[2rem] border border-navy-100 shadow-sm hover:shadow-md transition-all group">
              ...
              <h3 className="text-xl font-heading font-bold text-navy-900 mb-4">Email Us</h3>
              <a href="mailto:admin@krrschools.com" className="text-navy-600 hover:text-gold-600 transition-colors break-words">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-[3rem] shadow-xl overflow-hidden flex flex-col lg:flex-row border border-navy-100">
            ...
            <div className="w-full lg:w-3/5 p-8 lg:p-16">
              <h2 className="text-3xl lg:text-4xl font-heading font-bold text-navy-900 mb-8">Leave a Message</h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-bold text-navy-700 mb-2">Your Full Name *</label>
                    <input 
                      type="text" 
                      name="fullName"
                      required
                ...
                <div>
                  <label className="block text-sm font-bold text-navy-700 mb-2">Your Message</label>
                  <textarea 
                    rows="5"
                    name="message"
            ...
            <div className="w-full lg:w-2/5 relative min-h-[400px]">
              ...
              <div className="absolute inset-0 bg-navy-900/40 backdrop-blur-[1px] flex items-center justify-center p-12">
                <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-[2rem] p-8 text-white text-center">
                  <h3 className="text-2xl font-heading font-bold mb-4 text-gold-400">Join KRR BrightMinds</h3>
                  <p className="text-navy-50 mb-6">Experience world-class education with Indian values. Our team is ready to assist you in every step.</p>
                  <div className="flex justify-center gap-4">
                    <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center"><Phone className="w-5 h-5" /></div>
                    <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center"><Mail className="w-5 h-5" /></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-12 lg:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-navy-900 mb-4">Quick Inquiries</h2>
            <div className="w-20 h-1.5 bg-gold-500 mx-auto rounded-full"></div>
          </div>

          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: GraduationCap, title: "Admissions", desc: "Get complete admission details and application support." },
              { icon: Coffee, title: "Hostel", desc: "Know more about hostel facilities, safety, and accommodation." },
              { icon: Bus, title: "Transport", desc: "Learn about bus routes, GPS tracking, and transport facilities." },
              { icon: Briefcase, title: "Careers", desc: "Contact us regarding teaching and non-teaching opportunities." }
            ].map((item, idx) => (
              <div key={idx} className="bg-navy-50 p-8 rounded-[2rem] border border-navy-100 hover:border-gold-400 hover:bg-white transition-all group text-center shadow-sm">
      ...
      <section className="py-12 lg:py-16 bg-navy-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4">School Timings</h2>
            <div className="w-20 h-1.5 bg-gold-500 mx-auto rounded-full"></div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={idx} className="bg-white/5 border border-white/10 p-8 rounded-[2rem] text-center">
                <Clock className="w-8 h-8 text-gold-400 mx-auto mb-4" />
                <h4 className="text-navy-300 text-sm uppercase tracking-widest mb-2 font-bold">{item.label}</h4>
      ...
      <section className="py-12 lg:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-navy-900 mb-4">Find Us on Map</h2>
            <div className="w-20 h-1.5 bg-gold-500 mx-auto rounded-full"></div>
          </div>
          <div className="bg-navy-50 rounded-[3rem] overflow-hidden shadow-xl h-[450px] border border-navy-100">
            ...
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3821.571408331191!2d81.2582789!3d16.7118182!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a36746868686869%3A0x6868686868686868!2sKRR%20BrightMinds%20School!5e0!3m2!1sen!2sin!4v1716712345678!5m2!1sen!2sin" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
              allowFullScreen="" 
              ...
              title="KRR BrightMinds School Location"
            ></iframe>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 lg:py-16 bg-navy-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-navy-900 mb-4">General Questions</h2>
            <div className="w-20 h-1.5 bg-gold-500 mx-auto rounded-full"></div>
          </div>
